...
def run():
    ...
    for r in ['r3', 'r4', 'r5', 'r1']:
        net.getNodeByName(r).cmd("echo 1 > /proc/sys/net/ipv4/ip_forward")
        net.getNodeByName(r).cmd("/etc/init.d/quagga start")
    
    import time
    time.sleep(10)
    net.getNodeByName('r2').cmd("echo 1 > /proc/sys/net/ipv4/ip_forward")
    net.getNodeByName('r2').cmd("/etc/init.d/quagga start")
